...
import bannerPic from '/public/banners/privacy.png';
import styles from './privacypolicy.module.css';

/* this page was created from www.privacypolicies.com */
/* hello */
    ...
    return (
        <main>
            <section className={styles.bannerSection}>
                ...
                <Image
                    src={bannerPic}
                    alt='Privacy Policy banner picture'
                    priority={true}
            ...
            <section className={styles.pageContent}>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Urban Living at Fanno Creek, 12547 SW Main
                            St Tigard, OR 97223.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Urban Living at
                            Fanno Creek, accessible from{' '}
                            <a
                                href='https://www.urbanlivingatfanno.com'
                                rel='external nofollow noopener'
                                target='_blank'
                            >
                                https://www.urbanlivingatfanno.com
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: info@urbanlivingatfanno.com</li>
                </ul>
                <br />
                <br />
                <br />
